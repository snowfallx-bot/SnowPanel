...
- service tests 已覆盖 enqueue-only、idempotency duplicate、worker claim/execute、claim only once、stale lease recovery、failure retry、max attempts、queued/running cancellation、long-running heartbeat
