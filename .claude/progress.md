...
- service tests 已覆盖 enqueue-only、worker claim/execute、claim only once、stale lease recovery、failure retry、max attempts、queued/running cancellation、long-running heartbeat
