...
- Login endpoint has in-memory brute-force protection keyed by `username + client IP`.
...
- Expand rate-limiting and lockout from single-process memory mode to distributed/shared state.
