...
- service tests 已覆盖 enqueue-only、idempotency duplicate、worker claim/execute、worker context cancel、claim-only-once、stale lease recovery、失败重试、max-attempt 耗尽、排队/运行中取消、长任务 heartbeat 与 task metric 记录。
